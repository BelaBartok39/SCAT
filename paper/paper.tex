...
% ====================================================================
% ---- masthead ------------------------------------------------------
% University of Memphis primary palette: University Blue PMS 287 C and
% Memphis Gray PMS 423 C.
\definecolor{uofmBlue}{HTML}{10498D}
\definecolor{uofmGray}{HTML}{898D8D}

% To use the real artwork instead of the wordmark below, download the
% approved vector logo from memphis.edu/communications/brand, drop it
% in this directory, and uncomment the next line:
% \renewcommand{\institutionlogo}{uofm-logo.pdf}

\renewcommand{\mastheadwordmark}{%
  {\color{uofmBlue}\fontsize{19}{21}\selectfont\bfseries
   UNIVERSITY OF MEMPHIS}\\[3pt]
  {\color{uofmGray}\rule{2.55in}{0.6pt}}\\[3pt]
  {\color{uofmBlue}\fontsize{10}{12}\selectfont
...
\renewcommand{\extrasidebarblock}{%
  \jasidebarrule
  \textbf{Lab}\par
  \href{https://www.memphis.edu/cfia/}{Center for Information
  Assurance (CfIA)}, University of Memphis --- a National Center of
  Academic Excellence in Cybersecurity.\par}
...
\renewcommand{\paperaffiliations}{%
  \textbf{1} Center for Information Assurance (CfIA), Department of
  Computer Science, University of Memphis, Memphis, TN, USA}
...
This work was carried out at the Center for Information Assurance
(CfIA) at the University of Memphis, a National Center of Academic
Excellence in Cybersecurity designated by the National Security Agency
and the Department of Homeland Security. The authors thank \needdata{}.

\guide{If any part of this work sits under a named CfIA grant --- the
NCAE-C critical-infrastructure cybersecurity award, for instance ---
name it and its number here. Funders generally require the
acknowledgement, and reviewers read this section for conflicts.}
